...
class _MyHomePagesState extends State<MyHomePages> {
  ...
  void initState() {
    ...
    controller.addListener(() {
      final offsetRatio = controller.offset / 120;
      setState(() {
        myTopContainer = offsetRatio;
  ...
  void myBodyItems() {
    List<Widget> listitems = dataItems.map((ScrollItems items) {
      return SizedBox(
  ...
  Container discoverItems(Size size, Color color, String name, String items) {
    return Container(
